...
BEGIN
  ...
  SELECT EXISTS(
    ...
    WHERE om.user_id = existing_user_id 
      AND om.organization_id = restore_user_if_exists.organization_id
  ...
  VALUES (restore_user_if_exists.organization_id, existing_user_id, user_role, true)
