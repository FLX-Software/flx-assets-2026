...
const MaintenanceTimeline: React.FC<MaintenanceTimelineProps> = ({ asset, isAdmin, onUpdateHistory, onUpdateMaintenanceData }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    let updatedHistory: RepairEntry[];
    if (editingId) {
      updatedHistory = asset.repairHistory.map(e => 
        e.id === editingId ? { ...formData as RepairEntry, id: editingId } : e
      );
    } else {
      ...
      updatedHistory = [...asset.repairHistory, newEntry];
    }
